//Needs to be broken up into multiple classes. GUI should be by itself.
//Lack of comments needs filxing
//
...
public class SimpleNotePadCommented extends JFrame implements ActionListener{
	//Should make code easier to follow, either by grouping variable with methods that act on them
	//and/or give better object names
    ...
    //Main method should be at top or bottom, not lost in the file. Also should probably
    //be moved to its own class.
    public static void main(String[] args) {
        SimpleNotePadCommented app = new SimpleNotePadCommented();
    }
    //Needs to be broken up into smaller methods, currently a monolith that is impossible to read
    //If else chain is a mess
    @Override
